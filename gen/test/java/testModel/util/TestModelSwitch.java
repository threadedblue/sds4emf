...
public class TestModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestModelPackage.ACLASS: {
				AClass aClass = (AClass)theEObject;
				T result = caseAClass(aClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestModelPackage.BCLASS: {
				BClass bClass = (BClass)theEObject;
				T result = caseBClass(bClass);
				if (result == null) result = caseAClass(bClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestModelPackage.CCLASS: {
				CClass cClass = (CClass)theEObject;
				T result = caseCClass(cClass);
				if (result == null) result = caseBClass(cClass);
				if (result == null) result = caseAClass(cClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
